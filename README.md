...
| Роль             | Принимаемое количество активных пользователей в день | Среднее количество запросов к BE в день                           | Среднее количество запросов к BE в секунду | 
|------------------|------------------------------------------------------|-------------------------------------------------------------------|--------------------------------------------|
| Все пользователи | 50 млн всего, 18 млн ежемесячно, 2 млн в день        |                                                                   |                                            | 
| HR               | 2,5 млн                                              | 47 действий * 5 (запросов к BE на действие) * 0,28 млн = 70 млн.  | 761 запросов в секунду                     | 
| Соискатель       | 15,5 млн                                             | 27 действий * 4 (запросов к BE на действие) * 1,7 млн =  170 млн. | 1_967 запросов в секунду                   | 
| __Итог__         | 18 млн                                               | __240 млн.__                                                      | __2_728 запросов в секунду__
